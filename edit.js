...
// edit.js এর ভেতরে আপডেট ফাংশন
async function updateData() {
    const title = document.getElementById('edit-title').value;
    const body = editor.root.innerHTML; // এডিটরের কন্টেন্ট
    const img = document.getElementById('edit-img-url').value;

    // video-handler.js এর ফাংশনটি ব্যবহার করা হচ্ছে
    const success = await saveWithVideoFix(activePath, title, body, img);
